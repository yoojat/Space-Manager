"""
Production settings for Space Manager project.
...
#                          default='Space Manager <noreply@space.co>')
# EMAIL_SUBJECT_PREFIX = env('DJANGO_EMAIL_SUBJECT_PREFIX', default='[Space Manager]')
