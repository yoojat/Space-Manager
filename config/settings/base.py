"""
Base settings for Space Manager project.
...
THIRD_PARTY_APPS = [
    ...
    'corsheaders'  # To accept reqeusts from React
]
...
LOCAL_APPS = [
    ...
    'space_manager.cabinets.apps.CabinetsConfig',
    'space_manager.qrcodes.apps.QrcodesConfig',
]
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {'sites': 'space_manager.contrib.sites.migrations'}
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///space_manager'),
}
...
# ALLOWED_HOSTS = ['17fb425d.ngrok.io', 'localhost']
ALLOWED_HOSTS = ['*']


REST_AUTH_SERIALIZERS = {
    'USER_DETAILS_SERIALIZER':
    'space_manager.users.serializers.UserProfileSerializer',
}
