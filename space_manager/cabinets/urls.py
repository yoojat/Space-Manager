...
urlpatterns = [
    ...
    url(regex=r'^staff/modify/$',
        ...
        name='ModifyCabinet'),
    url(regex=r'^staff/cablock/add/$',
        view=views.AddCabinetLock.as_view(),
        name='AddCabinetLock'),
    url(regex=r'^staff/cabinets/(?P<branch_id>[0-9]+)/$',
        view=views.CabinetsByBranch.as_view(),
        name='CabinetsByBranch'),
    url(regex=r'^staff/cablock/(?P<cabinet_id>[0-9]+)/$',
        view=views.GetCabinetLock.as_view(),
        name='GetCabinetLock'),
    url(regex=r'^staff/cablock/delete/(?P<lock_id>[0-9]+)/$',
        view=views.DeleteCabinetLock.as_view(),
        name='DeleteCabinetLock'),
    url(regex=r'^staff/cablock/lockid/(?P<lock_id>[0-9]+)/$',
        view=views.GetCabinetLockByID.as_view(),
        name='GetCabinetLockByID'),
]
