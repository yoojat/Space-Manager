...
const BranchChoiceForCabinetStaff = props => {
  const { branches, sel_branch, onBranchClick, loading } = props;
  return loading ? (
    <Loading />
  ) : (
    <div>
...
BranchChoiceForCabinetStaff.propTypes = {
...
export default BranchChoiceForCabinetStaff;
