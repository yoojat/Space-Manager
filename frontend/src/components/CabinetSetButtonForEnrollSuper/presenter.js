...
const CabinetSetButtonForEnrollSuper = (props, context) => {
  const {
    cabinet_set,
    temp_cabinet_set,
    sel_cabinet_set,
...
CabinetSetButtonForEnrollSuper.propTypes = {};

CabinetSetButtonForEnrollSuper.contextTypes = {
  t: PropTypes.func.isRequired
};

export default CabinetSetButtonForEnrollSuper;
