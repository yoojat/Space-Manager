...
const ExtendPeriodChoiceSuper = (props, context) => {
  const {
    membership_extend,
...
ExtendPeriodChoiceSuper.propTypes = {};

ExtendPeriodChoiceSuper.contextTypes = {
  t: PropTypes.func.isRequired
};

export default ExtendPeriodChoiceSuper;
