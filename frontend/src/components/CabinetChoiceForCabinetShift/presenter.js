...
const CabinetChoiceForCabinetShift = (props, context) => {
  const { sel_cabinet_set, loading, onCabinetClick, target_cabinet } = props;

  return (
    <Element name="CabinetChoiceForCabinetShift">
      {loading ? (
        <Loading />
      ) : (
        <ShowCabinets
...
CabinetChoiceForCabinetShift.propTypes = {};

export default CabinetChoiceForCabinetShift;
