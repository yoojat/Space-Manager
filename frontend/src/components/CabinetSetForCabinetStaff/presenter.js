...
const CabinetSetForCabinetStaff = (props, context) => {
  const {
    cabinet_set,
...
CabinetSetForCabinetStaff.propTypes = {};

CabinetSetForCabinetStaff.contextTypes = {
  t: PropTypes.func.isRequired
};

export default CabinetSetForCabinetStaff;
