...
const ExtendMembershipResult = (props, context) => {
  const {
    extendMembership,
    enrollCabinet,
    extendCabinet,
  ...
  return (
    <Element
      name="ExtendMembershipResult"
      className={styles.extendMembershipResult}
    >
...
ExtendMembershipResult.propTypes = {};

ExtendMembershipResult.contextTypes = {
...
export default ExtendMembershipResult;
