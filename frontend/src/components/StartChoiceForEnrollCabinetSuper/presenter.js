...
const StartChoiceForEnrollCabinetSuper = (props, context) => {
...
StartChoiceForEnrollCabinetSuper.propTypes = {
  onStartDatetimeChange: PropTypes.func,
  membership_cost_types: PropTypes.array,
  start_datetime: PropTypes.string
};

StartChoiceForEnrollCabinetSuper.contextTypes = {
  t: PropTypes.func.isRequired
};

export default StartChoiceForEnrollCabinetSuper;
