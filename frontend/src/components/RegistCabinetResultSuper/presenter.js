...
const RegistCabinetResultSuper = (props, context) => {
    ...
    <div>
      ...
      {extendCabinet.sel_cabinet_costtype ? (
        <ExtendCabinetResult
          ...
          target_user={extendCabinet.target_user}
          now_datetime={now_datetime}
        />
      ) : (
        ""
...
const ExtendCabinetResult = (props, context) => {
  ...
  return (
    <div className={styles.membershipResultContainer}>
      ...
      {cabinets_extend.map(cabinet_extend => (
        <div className={styles.cabinetResultContainer} key={cabinet_extend.id}>
          <div className={styles.card}>
            <div className={styles.cardLeft}>
              <div className={styles.cardTop}>
                <div className={styles.logoCon}>
              ...
              <div className={styles.cardMiddle}>
                ...
                <div className={styles.contentCon}>
                  <div className={styles.textCon}>
                    ...
                    <div className={styles.branchCon}>
                      지점명 :<br />
                      {cabinet_extend.cabinet_set.branch.branch_name}
                    </div>
                    <div className={styles.datetimeCon}>
                      등록일시 :<br />
                      {now_datetime}
                    ...
                    <div className={styles.fromtoCon}>
                      <div className={styles.toCon}>
                        ...
                        <div className={styles.right}>
                          ...
                          -{" "}
                          {moment(cabinet_extend.end_date)
                            .add(Number(sel_cabinet_costtype.days) * 24, "h")
                  ...
                  <div className={styles.mainTextCon}>
                    <div className={styles.timeCon}>
                      등록시간<br /> {sel_cabinet_costtype.days}일
                    </div>
                  </div>
                </div>
              </div>
...
RegistCabinetResultSuper.propTypes = {};

RegistCabinetResultSuper.contextTypes = {
...
export default RegistCabinetResultSuper;
